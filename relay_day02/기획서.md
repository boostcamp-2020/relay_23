...
1. 사용자가 올린 이미지에서 텍스트를 추출한다. (OCR 이용)
    - 제약사항 : 텍스트는 손글씨가 아닌 컴퓨터 폰트에 제한한다.
        - ex) 번역 가능(컴퓨터 폰트)
            ...
            <center><img src="images/_2020-07-31__3.30.35.png" width="25%" height="25%"></center>

        - ex) 번역 불가(손 글씨)
             
            <center><img src="images/_2020-07-31__3.31.02.png" alt="_2020-07-31__3.31.02" width="25%" height="25%"></center>
...
## 플로우차트
   ...
   <center><img src="images/Untitled 1.png" alt="Untitled 1" width="50%" height="50%"></center>
...
<img src="images/Untitled 2.png" alt="Untitled 2" width="25%" height="25%">
   
   
   
   
   <img src="images/Untitled 3.png" alt="Untitled 3" width="25%" height="25%">




 <img src="images/Untitled 4.png" alt="Untitled 4" width="25%" height="25%">
...
- 참고)
   ...
   <center><img src="images/Untitled 5.png" alt="Untitled 5" width="25%" height="25%"></center>
